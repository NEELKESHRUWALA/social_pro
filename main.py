...
async def generate_content(file: UploadFile = File(...)):
    if not ai_client:
        return {
            "caption": "Gemini API Key not configured. Please set it in .env file.",
            "hashtags": ["#ConfigureGemini", "#AIReady"]
        }
    ...
    try:
        ...
        1. An engaging, professional social media caption.
        2. A list of 10-15 trending and relevant hashtags.
        
        Format your response as a valid JSON object with 'caption' and 'hashtags' (list of strings) keys.
        ...
        try:
            ...
            return {
                "caption": response.text.split("\n")[0],
                "hashtags": ["#AIError", "#TryAgain"]
            }
